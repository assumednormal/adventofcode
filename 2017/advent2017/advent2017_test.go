...
// func TestDay19_Path_Part01(t *testing.T) {
// 	if v1 := Path(readFile("day19_test.txt")); v1 != "ABCDEF" {
// 		t.Error("Input 1 got ", v1)
// 	}
// }

// func TestDay19_Path_Part02(t *testing.T) {
// 	if v1 := PathSteps(readFile("day19_test.txt")); v1 != 38 {
// 		t.Error("Input 1 got ", v1)
// 	}
// }
